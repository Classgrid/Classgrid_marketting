...
const client = createClient({
  ...
  token: process.env.SANITY_API_READ_TOKEN, // Make sure we have write token or just write token
  useCdn: false,
});

// Using a write token if available, otherwise trying with the existing token
...
const enDoc = {
  ...
  content: {
    ...
    subtitle: "Company: Classgrid (A Product of Classgrid, MSME Registered) • NIC Code: 62011",
    ...
    p3_3_desc: "Like every modern software product, Classgrid is built using open-source technologies (Node.js, React, MongoDB, Redis, etc.). Patenting a product built on open-source components is neither practical nor ethical.",
  ...
  protectionMethods: [
    ...
    },
    {
      ...
      description: "Classgrid's proprietary business logic, algorithms, database architectures, multi-tenant design patterns, and internal system configurations are protected as trade secrets. These are never publicly disclosed and are safeguarded through: Private GitHub repositories, Environment variable encryption, Role-based access control, and Non-disclosure agreements (NDAs).",
      iconName: "Lock",
    },
    {
    ...
    },
    {
      ...
      description: "Classgrid is registered as a Micro Enterprise with the Government of India under the MSME Development Act. This registration provides official government recognition of Classgrid as a legitimate business entity.",
      iconName: "Landmark",
    },
    {
  ...
  protectionMethods: [
    {
      ...
      status: "active",
      basis: "Indian Copyright Act, 1957 + Berne Convention",
      description: "Indian Copyright Act, 1957 और Berne Convention के तहत, सभी मूल Source Code, Documentation, UI Designs और Content उनके निर्माण के समय से ही स्वचालित रूप से कॉपीराइट द्वारा संरक्षित होते हैं। जो संरक्षित है: सभी Source Code, Database Schemas, API Designs, UI/UX Designs, Documentation, Blog Content, Email Templates, और Marketing Materials। अवधि: लेखक का जीवनकाल + 60 वर्ष (भारत) / 70 वर्ष (अंतर्राष्ट्रीय)।",
      iconName: "Copyright",
    },
    {
      ...
      description: "Classgrid का स्वामित्व वाला Business Logic, Algorithms, Database Architectures, Multi-Tenant Design Patterns और आंतरिक System Configurations Trade Secrets के रूप में संरक्षित हैं। इन्हें कभी भी सार्वजनिक रूप से प्रकट नहीं किया जाता है और इनके माध्यम से सुरक्षित रखा जाता है: निजी GitHub Repositories, Environment Variable Encryption, Role-Based Access Control, और Non-Disclosure Agreements (NDAs)।",
      iconName: "Lock",
    },
    {
    ...
    },
    {
      ...
      status: "active",
      basis: "UDYAM-MH-01-0308803",
      description: "Classgrid भारत सरकार के अंतर्गत Micro Enterprise के रूप में MSME Development Act के तहत पंजीकृत है। यह पंजीकरण Classgrid को एक वैध व्यावसायिक इकाई के रूप में आधिकारिक सरकारी मान्यता प्रदान करता है।",
      iconName: "Landmark",
    },
    {
  ...
  protectionMethods: [
    {
      ...
      status: "active",
      basis: "Indian Copyright Act, 1957 + Berne Convention",
      description: "Indian Copyright Act, 1957 आणि Berne Convention (आंतरराष्ट्रीय) अंतर्गत, सर्व मूळ Source Code, Documentation, UI Designs आणि Content हे तयार झाल्याच्या क्षणापासून स्वयंचलितपणे कॉपीराइटद्वारे संरक्षित असतात. काय संरक्षित आहे: सर्व Source Code, Database Schemas, API Designs, UI/UX Designs, Documentation, Blog Content, Email Templates, आणि Marketing Materials. कालावधी: लेखकाचे जीवनमान + ६० वर्षे (भारत) / ७० वर्षे (आंतरराष्ट्रीय).",
      iconName: "Copyright",
    },
    {
      ...
      status: "active",
      basis: "Private repositories, सुरक्षित Credentials, NDAs",
      description: "Classgrid चे मालकी हक्क असलेले Business Logic, Algorithms, Database Architectures, Multi-Tenant Design Patterns आणि अंतर्गत System Configurations हे Trade Secrets म्हणून संरक्षित केले जातात. हे कधीही सार्वजनिकरित्या उघड केले जात नाहीत आणि याद्वारे संरक्षित केले जातात: खाजगी GitHub Repositories, Environment Variable Encryption, Role-Based Access Control, आणि Non-Disclosure Agreements (NDAs).",
      iconName: "Lock",
    },
    {
      method: "4.3 ट्रेडमार्क संरक्षण",
    ...
    },
    {
      ...
      status: "active",
      basis: "UDYAM-MH-01-0308803",
      description: "Classgrid ची भारत सरकारकडे MSME Development Act अंतर्गत Micro Enterprise म्हणून नोंदणी करण्यात आली आहे. ही नोंदणी Classgrid ला एक कायदेशीर व्यावसायिक संस्था म्हणून अधिकृत सरकारी मान्यता प्रदान करते.",
      iconName: "Landmark",
    },
    {
...
async function upload() {
  try {
    ...
    console.log("Successfully uploaded IP protection docs to Sanity!");
  } catch (error) {
