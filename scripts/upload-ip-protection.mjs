...
const enDoc = {
  ...
  content: {
    ...
    statusActive: "Active",
    statusNA: "Not Currently Pursued",
    statusNo: "No",
  ...
  protectionMethods: [
    ...
    },
    {
      ...
      description: "Indian Patent Law explicitly excludes \"computer programmes per se\" and business methods from patentability. This principle is well-established in Indian patent law.",
      iconName: "XCircle",
    },
  ],
  investorTable: [
    ...
    { method: "Patent", status: "❌ Not currently pursued", basis: "Section 3(k), The Patents Act, 1970" },
...
const hiDoc = {
  ...
  protectionMethods: [
    ...
    },
    {
      ...
      status: "not-applicable",
      basis: "Section 3(k), The Patents Act, 1970",
      description: "भारतीय पेटेंट कानून The Patents Act, 1970 की Section 3(k) में computer programmes per se, business methods और algorithms की पेटेंट योग्यता पर स्पष्ट सीमाएँ निर्धारित की गई हैं। यह सिद्धांत भारतीय पेटेंट कानून में अच्छी तरह से स्थापित है।",
      iconName: "XCircle",
    },
  ],
  investorTable: [
    ...
    { method: "पेटेंट", status: "❌ वर्तमान में नहीं", basis: "Section 3(k), The Patents Act, 1970" },
...
const mrDoc = {
  ...
  protectionMethods: [
    ...
    },
    {
      ...
      status: "not-applicable",
      basis: "Section 3(k), The Patents Act, 1970",
      description: "भारतीय पेटंट कायद्यातील The Patents Act, 1970 च्या Section 3(k) मध्ये computer programmes per se, business methods आणि algorithms यांच्या पेटंटयोग्यतेवर स्पष्ट मर्यादा घालण्यात आल्या आहेत. हे तत्त्व भारतीय पेटेंट कायद्यात चांगल्या प्रकारे प्रस्थापित आहे.",
      iconName: "XCircle",
    },
  ],
  investorTable: [
    ...
    { method: "पेटंट", status: "❌ सध्या नाही", basis: "Section 3(k), The Patents Act, 1970" },
    { method: "Terms of Service", status: "✅ प्रकाशित", basis: "classgrid.in/terms" },
    { method: "Privacy Policy", status: "✅ प्रकाशित", basis: "classgrid.in/privacy" },
  ],
};
