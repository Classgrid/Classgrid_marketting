...
const megaMenus: MegaMenu[] = [
  {
    ...
    columns: [
      ...
      },
      {
        heading: "Experience",
        links: [
          { label: "Student App", href: "/tour", description: "Everything students need in one place." },
          { label: "Parent App", href: "/tour", description: "Transparent communication for guardians." },
          { label: "Teacher Workspace", href: "/tour", description: "Daily academic operations made simple." },
        ],
      },
    ],
  },
  {
    ...
    columns: [
      ...
      },
      {
        heading: "By Role",
        links: [
          { label: "Management", href: "/tour", description: "Executive dashboards and analytics." },
          { label: "Administrators", href: "/tour", description: "Single command center for operations." },
          { label: "Teachers", href: "/tour", description: "Classroom-first, low-friction tools." },
        ],
      },
      {
        heading: "By Outcome",
...
const utilityColumns: Array<{ heading: string; links: MenuLink[] }> = [
  ...
  { heading: "Support", links: [{ label: "Help Center", href: "/support" }, { label: "Book Demo", href: "/demo" }, { label: "Contact Sales", href: "/contact/sales" }] },
];
      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/demo"
            prefetch
            className="hidden h-9 items-center justify-center rounded-lg border border-border bg-foreground px-4 text-sm font-semibold text-background transition hover:opacity-90 lg:inline-flex"
          >
            Book a Demo
          </Link>
          ...
          <Link
            href="/demo"
            prefetch
            className="inline-flex h-9 items-center gap-2 rounded-lg border border-border bg-foreground px-3 text-xs font-semibold text-background transition hover:opacity-90 lg:hidden"
          >
      ...
      <div className="border-t border-border bg-background/95">
        <div className="mx-auto grid max-w-7xl items-center gap-3 px-4 py-4 text-xs sm:grid-cols-3 sm:px-6 lg:px-8">
          <div className="inline-flex items-center justify-center gap-2 text-muted-foreground sm:justify-start">
            ...
            <span className="font-medium tracking-wide">CLASSGRID CLOUD STATUS: OPERATIONAL</span>
          </div>
          <div className="inline-flex items-center justify-center gap-3 text-muted-foreground">
            <span>© {new Date().getFullYear()} Classgrid Technologies.</span>
            <span>•</span>
