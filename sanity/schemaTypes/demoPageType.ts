...
export const demoPageType = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      rows: 2,
      initialValue:
        'Fill out the form below with your institution details. The Classgrid team will review your request and connect with you to schedule a guided demo consultation.',
    }),
    defineField({
      name: 'benefits',
    ...
    defineField({
      ...
      rows: 2,
      initialValue:
        'Your demo request has been received. The Classgrid team will review it and connect with you to schedule the next discussion.',
    }),
    defineField({
      name: 'seo',
      title: 'SEO',
