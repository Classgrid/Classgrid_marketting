...
export const integrationItemType = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'logo', title: 'Uploaded Logo', type: 'image', options: { hotspot: true } }),
    defineField({
      name: 'logoUrl',
      title: 'External Logo URL',
      type: 'url',
      description: 'Supports Supabase, Wikipedia, CDN, and other public logo URLs.',
    }),
    ...
    defineField({
      ...
      type: 'url',
      description: 'Optional larger image URL for the integration.',
    }),
