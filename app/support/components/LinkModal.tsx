          ...
          >
            ...
            <div className="px-5 py-5 space-y-4">
              ...
              <p className="text-[11px] text-muted-foreground">
                Press <kbd className="px-1.5 py-0.5 rounded bg-muted border border-border text-[10px] font-mono font-medium">Enter</kbd> to insert · <kbd className="px-1.5 py-0.5 rounded bg-muted border border-border text-[10px] font-mono font-medium">Esc</kbd> to cancel
              </p>
            </div>
