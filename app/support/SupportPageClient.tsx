...
const CATEGORIES = [
  {
    title: "Technical Support / ERP / AI / API",
    description: "Troubleshoot software errors, ERP modules, AI assistant, and API integrations.",
    icon: Terminal,
    delay: 0.1,
  },
  {
    title: "Billing & Subscription",
    description: "Manage your invoices, plans, payments, and subscription queries.",
    icon: CreditCard,
    delay: 0.15,
  },
  {
    title: "Academics / Attendance / Admissions",
    description: "Student data, attendance tracking, biometric sync, and admission workflows.",
    icon: Users,
    delay: 0.2,
  },
  {
    title: "Examination Systems",
    description: "Admit cards, marksheets, grading setups, and result publishing.",
    icon: ClipboardList,
    delay: 0.25,
  },
  {
    title: "Communication & Scheduling",
    description: "Timetable conflicts, class scheduling, chat, and messaging issues.",
    icon: CalendarDays,
    delay: 0.3,
  },
  {
    title: "HR & Payroll / Finance",
    description: "Staff attendance, salary slips, leave management, and fee modules.",
    icon: Briefcase,
    delay: 0.35,
  },
  {
    title: "Getting Started",
    description: "Onboarding help, initial setup, first-time configuration, and walkthroughs.",
    icon: BookOpen,
    delay: 0.4,
  },
  {
    title: "Account & Security",
    description: "Login issues, password resets, MFA, profile settings, and access control.",
    icon: Key,
    delay: 0.45,
  },
  {
    title: "General Inquiry",
    description: "Pre-demo questions, institutional fit assessment, and partnership queries.",
    icon: MessageSquare,
    delay: 0.5,
  },
  {
    title: "Other",
    description: "Anything else — compliance, library, mobile app, or browser issues.",
    icon: Headphones,
    delay: 0.55,
  },
];
