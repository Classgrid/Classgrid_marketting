...
function LoginContent() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 dark:bg-[#0f0f0f] dark:text-white flex flex-col relative font-sans">
        ...
        <div className="w-full max-w-[400px]">
          ...
          <div className="flex flex-col gap-3 mb-8">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 rounded-md border border-slate-200 bg-[#fafafa] py-3 text-sm font-medium text-slate-900 transition-all duration-200 hover:bg-slate-100 active:scale-[0.98] dark:border-[#2a2a2a] dark:bg-[#161616] dark:text-[#f1f1f1] dark:hover:bg-[#1f1f1f]"
            >
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-white dark:bg-[#0f0f0f] flex items-center justify-center"><Loader2 className="w-6 h-6 text-[#888] animate-spin" /></div>}>
      <LoginContent />
    </Suspense>
  );
}
