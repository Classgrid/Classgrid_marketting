...
export async function POST(request: NextRequest) {
  try {
    ...
    const githubProfileHtml = githubUsername && githubProfileUrl 
  ...
  <div style="background:#ffffff;border:1px solid #eaeaea;border-radius:16px;padding:32px;">
    ...
    <table style="width:100%;border-collapse:collapse;">
      ...
      <tr>
        ...
        <td style="padding:12px 0;color:#111111;font-size:14px;border-bottom:1px solid #eaeaea;">${githubCombinedHtml}</td>
      </tr>
      <tr>
