    ...
    <>
      ...
      <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8 relative">
        <article className="w-full">
          ...
          {/* ---------------- 7. AUTHOR FOOTER ---------------- */}
          <MotionDiv initial="hidden" whileInView="visible" viewport={{ once: true }} variants={slideUp} className="mt-12 border-t border-border pt-10 pb-6 flex flex-col md:flex-row items-center md:items-start gap-6">
            {(() => {
              ...
              return primaryUrl ? <a href={primaryUrl} target="_blank" rel="noreferrer" title={`Visit ${authorName}'s profile`}>{avatarEl}</a> : avatarEl;
            })()}
