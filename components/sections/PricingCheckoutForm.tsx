    ...
    <div className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-white/10 dark:bg-slate-950/50">
      ...
      <div className="mt-4 grid gap-4 md:grid-cols-2">
        <div className="space-y-2">
          <Label htmlFor="orgId" className="text-slate-700 dark:text-slate-200">
            {pricingCopy.orgIdLabel}
          </Label>
          <Input
            id="orgId"
            className="h-10 border-slate-300 bg-white text-slate-900 dark:border-white/15 dark:bg-slate-950/50 dark:text-white"
        ...
        <div className="space-y-2">
          <Label htmlFor="billingCycle" className="text-slate-700 dark:text-slate-200">
