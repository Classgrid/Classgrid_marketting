...
export const PLATFORM_RESOURCES: PlatformResource[] = [
  ...
  {
    label: "Solutions for Engineering",
    href: "/solutions/for-engineering",
    description: "Classgrid solutions for engineering colleges and technical institutes.",
    category: "product",
    keywords: ["engineering", "technical", "btech", "engineering college"],
  },
  {
    label: "Solutions for Schools",
    href: "/solutions/for-schools",
    description: "Classgrid solutions for K-12 schools.",
    category: "product",
    keywords: ["school", "k12", "primary", "secondary"],
  },
  {
    label: "Solutions for Junior Colleges",
    href: "/solutions/for-junior-colleges",
    description: "Classgrid solutions for junior colleges and higher secondary institutions.",
    category: "product",
    keywords: ["junior college", "hsc", "11th", "12th", "higher secondary"],
  },
  {
    label: "Solutions for Coaching",
    href: "/solutions/for-coaching",
    description: "Classgrid solutions for coaching centers and tutorial institutes.",
    category: "product",
    keywords: ["coaching", "tutorial", "coaching center", "classes"],
  },
  {
    label: "Institutions - College",
    href: "/institutions/college",
    description: "Classgrid for colleges and degree-granting institutions.",
    category: "product",
    keywords: ["college", "degree", "university"],
  },
  {
    label: "Institutions - Engineering",
    href: "/institutions/engineering",
    description: "Classgrid for engineering and technical institutions.",
    category: "product",
    keywords: ["engineering", "technical institute"],
  },
  {
    label: "Institutions - Junior College",
    href: "/institutions/junior-college",
    description: "Classgrid for junior colleges.",
    category: "product",
    keywords: ["junior college", "hsc"],
  },
  {
    label: "Institutions - Coaching",
    href: "/institutions/coaching",
    description: "Classgrid for coaching centers.",
    category: "product",
    keywords: ["coaching", "classes"],
  },
  {
    label: "Institutions - School",
    href: "/institutions/school",
    description: "Classgrid for schools.",
    category: "product",
    keywords: ["school", "k12"],
  },
  {
