...
function buildSystemPrompt(params: {
  ...
  return [
    ...
    "- INTERNAL THOUGHT RULE: If you use the 'internal_thought_process' tool, DO NOT use it multiple times in a row. You must immediately follow it up with an actual action like 'search_web' or 'read_url' to gather data, or just provide your final answer to the user.",
