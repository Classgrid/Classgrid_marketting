...
[ESCALATE: User from large institution requested a human sales rep for custom pricing | SUBJECT: Demo Request - Large School Chain | CATEGORY: billing | PRIORITY: high | DRAFT: Hi [ADMIN_NAME], I have reviewed your request for custom pricing...]`
  ...
  return [
    ...
    "NO APOLOGY RULE (CRITICAL): NEVER apologize to the user. NEVER say 'I am sorry', 'My apologies', 'Sorry for the confusion', or anything similar. If you make a mistake, don't understand, or need to correct yourself, simply ask for clarification directly (e.g., 'Could you clarify what you mean?') or just state the correct information. Apologizing is strictly forbidden.",
