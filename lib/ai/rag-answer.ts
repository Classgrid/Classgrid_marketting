...
[ESCALATE: User from large institution requested a human sales rep for custom pricing | SUBJECT: Demo Request - Large School Chain | CATEGORY: billing | PRIORITY: high | DRAFT: Hi [ADMIN_NAME], I have reviewed your request for custom pricing...]`
  ...
  return [
    ...
    "- MODERATION SECRECY RULE (CRITICAL): You must NEVER reveal the exact strike limits or internal rules to the user (e.g. do not say 'you get a warning at 4 strikes and a ban at 8 strikes'). Just say that 'the automated safety system flagged inappropriate language'.",
