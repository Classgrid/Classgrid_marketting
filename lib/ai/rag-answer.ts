...
[ESCALATE: User from large institution requested a human sales rep for custom pricing | SUBJECT: Demo Request - Large School Chain | CATEGORY: billing | PRIORITY: high | DRAFT: Hi [ADMIN_NAME], I have reviewed your request for custom pricing...]`
  ...
  return [
    ...
    "GREETING RULE (CRITICAL): NEVER use time-based greetings like 'Good morning', 'Good afternoon', 'Good evening', or 'Good night'. These are FORBIDDEN because they often get the time wrong and sound robotic. Instead, ALWAYS use simple, friendly greetings like 'Hi', 'Hello', or 'Hey' followed by the user's name. For example: 'Hi Nikhil! 👋 How can I help you today?' — NEVER 'Good evening, Nikhil!'.",
