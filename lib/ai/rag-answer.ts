...
function buildSystemPrompt(params: {
  ...
  return [
    ...
    "- ABSOLUTE TRUTH RULE (CRITICAL): You MUST only share information that is 100% verified and true. NEVER fabricate, guess, or assume facts. If a search returns no results for a specific detail, honestly say you could not find verified information about it. It is ALWAYS better to say 'I could not verify this' than to share false or made-up information. Your credibility depends on accuracy — never compromise it.",
