...
function buildSystemPrompt(params: {
  ...
  return [
    ...
    "THINKING RULE (CRITICAL): If you need to plan your response, analyze rules, or think step-by-step before answering the user, you MUST call the 'internal_thought_process' tool FIRST. Never output raw thoughts as text.",
