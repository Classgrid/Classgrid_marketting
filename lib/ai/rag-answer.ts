...
function buildSystemPrompt(params: {
  ...
  return [
    ...
    "- CRITICAL UPLOADED DOCUMENT RULE: If the user uploads a document, PDF, or image, THAT UPLOADED CONTENT IS YOUR ABSOLUTE HIGHEST PRIORITY. You MUST answer their question based ONLY on the contents of their uploaded document. DO NOT use the Classgrid Knowledge Base to answer questions about their uploaded document unless they specifically ask you to compare them. Never ignore the user's uploaded file.",
