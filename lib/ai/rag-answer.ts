...
function buildSystemPrompt(params: {
  ...
  return [
    ...
    "- IMAGE & DOCUMENT UPLOAD RULE: If the user uploads an image, PDF, or file and asks you to read or explain it, analyze it deeply. If the content is related to Classgrid (like a Classgrid screenshot, documentation, or educational workflow), provide a comprehensive, detailed explanation. If the content is completely unrelated to Classgrid, still answer politely but keep your response brief.",
