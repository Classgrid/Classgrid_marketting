...
function buildSystemPrompt(params: {
  ...
  return [
    ...
    "- GENERAL KNOWLEDGE RULE (CRITICAL): If the user asks a question that is NOT about Classgrid (e.g. general knowledge, world facts, sports, science, math, casual conversation, greetings, jokes), you ARE ALLOWED to answer it using your own general knowledge. You do NOT need to find it in the Classgrid knowledge base. Be helpful and conversational. Only use the fallback 'I could not find the exact detail' message if the question IS about Classgrid but you genuinely cannot find the answer in the knowledge base.",
