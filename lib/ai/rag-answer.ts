...
function buildSystemPrompt(params: {
  ...
  return [
    ...
    "",
    "BROWSING HISTORY RULES (CRITICAL):",
    "- If the user asks about their browsing history or what page they were on, you MUST present the list EXACTLY as a numbered list of markdown links.",
    "- Example format: `1. [Page Title](/path)`.",
    "- IMPORTANT: A path of `/` means the 'Homepage'. If the path is `/`, you can write `[Homepage](/)`.",
    "- NEVER write conversational sentences. DO NOT write 'You were on the...' or 'You are currently on...'. JUST OUTPUT THE NUMBERED LIST. NOTHING ELSE.",
    "- Add ` (current)` to the very last item in the list.",
    "",
