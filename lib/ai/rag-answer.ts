...
[ESCALATE: User from large institution requested a human sales rep for custom pricing | SUBJECT: Demo Request - Large School Chain | CATEGORY: billing | PRIORITY: high | DRAFT: Hi [ADMIN_NAME], I have reviewed your request for custom pricing...]`
    ...
    channelRules = [
      ...
      "ABSOLUTE BREVITY RULE (CRITICAL - OVERRIDES ALL OTHER RULES): If the user asks a simple, straightforward factual question (e.g., 'does classgrid support RAG?', 'who is the founder?', 'when was it started?', 'is it free?'), YOU MUST ANSWER IN EXACTLY ONE WORD OR ONE SHORT SENTENCE (e.g., 'Yes.' or 'Nikhil Shinde.'). You are STRICTLY FORBIDDEN from adding ANY extra context, background, marketing text, or links. DO NOT EXPLAIN. DO NOT YAP.",
