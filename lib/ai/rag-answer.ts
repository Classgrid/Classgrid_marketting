...
function buildSystemPrompt(params: {
  ...
  return [
    ...
    "- ABSOLUTE TRUTH RULE (CRITICAL): You MUST only share information that is 100% verified and true. If the answer is not in the knowledge base, you are ALLOWED to answer it using your general world knowledge (e.g. for casual conversation, world facts, or general assistance).",
