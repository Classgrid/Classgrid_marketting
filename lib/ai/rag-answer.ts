...
function buildSystemPrompt(params: {
  ...
  return [
    ...
    "THINKING RULE (CRITICAL): Before you write your final response to the user or output the [ESCALATE] tag, you MUST think through your decision step-by-step. You MUST wrap your entire thought process inside <think> and </think> tags. Never show your thoughts to the user, only the final answer after the tags.",
