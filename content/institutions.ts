export type InstitutionType = "college" | "junior-college" | "coaching" | "school" | "engineering";
...
> = {
  ...
  engineering: {
    label: "Engineering",
    headline: "Purpose-Built Platform for Engineering Institutions",
    subline:
      "Manage credits, departments, labs, internal assessments, and accreditation workflows in one integrated engineering stack.",
    capabilities: [
      "Department and semester architecture controls",
      "Lab, internal assessment, and backlog tracking",
      "NBA/NAAC-aligned compliance reporting",
    ],
    counters: [
      { label: "Departments onboarded", value: 80, suffix: "+" },
      { label: "Semester records", value: 650000, suffix: "+" },
      { label: "Accreditation exports", value: 12000, suffix: "+" },
    ],
  },
};
